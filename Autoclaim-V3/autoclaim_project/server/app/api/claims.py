...
def reanalyze_claim(
    ...
    try:
        ...
        vehicle_make  = ai_analysis.get("identity", {}).get("vehicle_make")  or forensic_fields.get("vehicle_make")
        vehicle_model = ai_analysis.get("identity", {}).get("vehicle_model") or forensic_fields.get("vehicle_model")
        vehicle_year  = ai_analysis.get("identity", {}).get("vehicle_year")  or forensic_fields.get("vehicle_year")
