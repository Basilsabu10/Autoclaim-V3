# AutoClaim Price API — Router
# Copied from Price_api/app/api/price_estimate.py
# Updated imports to use the merged subpackage paths.
...
from app.price_api.service import build_estimate, VALID_PART_KEYS
...
async def import_prices(file: UploadFile = File(...), db: Session = Depends(get_db)):
    """
    Upload filled Excel/CSV to seed the price database.
